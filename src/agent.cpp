...
auto agent::act(uint_t t, bid_fn b, permit_public_status_fn s, int seed) -> bool { return interface_->act(t, std::move(b), std::move(s), seed); }

auto agent::after_trading(uint_t t, ask_fn a, permit_public_status_fn s, int seed) -> void { interface_->after_trading(t, std::move(a), std::move(s), seed); }
