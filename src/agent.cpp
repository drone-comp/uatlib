...
auto agent::on_bought(const slot& s, uint_t t, value_t v) -> void { interface_->on_bought(s, t, v); }

auto agent::on_sold(const slot& s, uint_t t, value_t v) -> void { interface_->on_sold(s, t, v); }
