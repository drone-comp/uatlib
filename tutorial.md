...
public:
  ...
  auto stop(uat::uint_t time, int seed) -> bool override {
    // ...
  }
...
```cmake
target_link_libraries(uatlib-tutorial PRIVATE uat jules fmt)
```

This should be enough to have a simple simulation of a first-price sealed-bid
auction.  You can now experiment with different strategies for the agents and
analyze the results.
